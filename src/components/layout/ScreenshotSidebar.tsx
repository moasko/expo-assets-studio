          ...
          <div className="flex gap-2 overflow-x-auto pb-3 -mx-1 px-1 scrollbar-thin">
             {screenshots.map((s, index) => (
               <button
                 ...
                 className={`shrink-0 w-14 h-[88px] rounded-xl border-2 transition-all duration-200 flex flex-col items-center justify-center relative overflow-hidden group ${
            ...
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button 
                ...
                className={`text-[10px] px-1.5 py-0.5 rounded transition-colors ${
                  activeScreenshot.showTitle ? 'text-[#0066ff] bg-[#0066ff]/10' : 'text-[#71717a] bg-[#27272a]'
                }`}
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button 
                ...
                className={`text-[10px] px-1.5 py-0.5 rounded transition-colors ${
                  activeScreenshot.showSubtitle ? 'text-[#0066ff] bg-[#0066ff]/10' : 'text-[#71717a] bg-[#27272a]'
                }`}
              >
          ...
          <div className="flex bg-[#27272a] p-[3px] rounded-lg relative">
            ...
            <button 
              ...
              className={`flex-1 relative z-10 py-2 rounded-[7px] text-[12px] font-medium transition-colors flex items-center justify-center gap-2 ${
                activeScreenshot.deviceType === 'ios' ? 'text-[#fafafa]' : 'text-[#71717a]'
              }`}
            >
            ...
            <button 
              ...
              className={`flex-1 relative z-10 py-2 rounded-[7px] text-[12px] font-medium transition-colors flex items-center justify-center gap-2 ${
                activeScreenshot.deviceType === 'android' ? 'text-[#fafafa]' : 'text-[#71717a]'
              }`}
            >
        ...
        <div className="px-4 space-y-5 pb-4">
              ...
              <div className="grid grid-cols-5 gap-2">
                 {GRADIENTS.map((grad, i) => (
                   <button
                     ...
                     className={`w-full aspect-square rounded-lg transition-all duration-200 ring-2 ring-offset-1 ring-offset-[#18181b] ${
                       activeScreenshot.bgGradient === grad 
           ...
           <div>
             ...
             <div 
               ...
               className={`relative group w-full border border-dashed rounded-xl p-4 flex flex-col items-center justify-center gap-2 cursor-pointer transition-all duration-200 ${
              ...
              <div className="flex bg-[#27272a] p-[3px] rounded-lg relative">
                ...
                {LAYOUT_OPTIONS.map((opt) => (
                  <button
                    ...
                    className={`flex-1 relative z-10 py-2.5 flex flex-col items-center gap-1 rounded-[7px] transition-colors ${
                      activeScreenshot.layout === opt.id
                      ? 'text-[#fafafa]'
